...
# Modifier "mail" et "token" avec vos informations personnelles disponibles dans le profil de votre compte Datagrosyst
data_request <- list(
  mail = "thomas.badie@inrae.fr",      # À modifier
  token = "6eb61f6f-88eb-4570-b7c0-4b957c18c716",    # À modifier
  tables = tables
)

# Les chemins vers vos dossiers locaux
path_download <- "/home/administrateur/Téléchargements"       # Modifier ici le chemin vers votre dossier de téléchargements
path_workdirectory <- "/home/administrateur/Bureau/test"               # Modifier ici le chemin vers votre dossier de travail
```
