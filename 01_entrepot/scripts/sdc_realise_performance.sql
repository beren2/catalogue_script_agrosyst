...
SELECT
    replace(replace(id_sdc,CHR(13)||CHR(10),'<br>'),CHR(10),'<br>') AS sdc_id,
    ...
    alerte_ift_chimique_total_hts AS alerte_ift_cible_mil_chim_tot_hts,
    alerte_ift_fongicide AS alerte_ift_cible_mil_f,
    alerte_ift_herbicide AS alerte_ift_cible_mil_h,
    alerte_ift_insecticide AS alerte_ift_cible_mil_i,
    alerte_ift_total_chimique_hts_biocontrole AS alerte_ift_cible_mil_biocontrole,
