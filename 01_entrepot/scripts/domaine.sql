CREATE TABLE entrepot_domaine AS
  ...
  SELECT
    ...
    d.maincontact,
    d.experimentalagriculturalarea,
    d.homogenizationexperimentalagriculturalarea,
    d.legalstatus,
    d.otex18,
    d.otex70,
    d.defaultweatherstation,
    d.objectives,
    d.domainassets,
    d.domainconstraints,
    d.domainlikelytrends,
    d.cooperativemember,
    d.developmentgroupmember,
    d.cumamember,
    d.stakestourist,
    d.operatorworkforce,
    d.nonseasonalworkforce,
    d.seasonalworkforce,
    d.volunteerworkforce,
    d.usedagriculturalareaforfarming,
    d.irrigablearea,
    d.fallowarea,
    d.annualcroparea,
    d.vineyardandorchardarea,
    d.meadowarea,
    d.meadowalwayswithgrassarea,
    d.meadowotherarea,
    d.meadowonlypasturedarea,
    d.meadowonlymowedarea,
    d.meadowpasturedandmowedarea,
    d.heathlandandroutesarea,
    d.summerandmountainpasturearea,
    d.collectiveheathlandandroutesarea,
    d.collectivesummerandmountainpasturearea,
    d.totalotherareas,
  FROM domain d
