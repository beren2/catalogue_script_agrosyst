...
def test_get_reseaux_rattachement_sdc_outils_tableau_de_bord_can():
    ...
    path_data = '02_outils/tests/data/test_get_reseaux_rattachement_sdc_outils_tableau_de_bord_can/'

    fonction_to_apply = outils_tableau_de_bord_can.get_reseaux_rattachement_sdc_outils_tableau_de_bord_can   
...
def test_get_surface_typo_culture_sdc_realise_outils_tableau_de_bord_can():
    """
        Test de l'obtention des surfaces de toutes les typo de culture pour chaque sdc en réalisé
    """

    identifiant_test = 'test_get_surface_typo_culture_sdc_realise_outils_tableau_de_bord_can'
...
def test_get_gestion_enherbement_sdc_outils_tableau_de_bord_can():
    ...
    identifiant_test = 'test_get_gestion_enherbement_sdc_outils_tableau_de_bord_can'
