select 
	...
	ei.semence_id, 
	CASE ei.lot_semence_bio WHEN true THEN 'oui' WHEN false THEN 'non' END lot_semence_bio,
	...
	CASE ei.effet_sdn WHEN true THEN 'oui' WHEN false THEN 'non' END effet_sdn,
	ei.forme_fert_min,
