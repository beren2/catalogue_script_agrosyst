-- SERT NTOTAMENT A AVOIR LA BASE POUR SDC_AGREGE, TOUT EN NE FAISANT PAS DES COPIER-COLLER POUR AVOIR SDC
create temporary table if not exists entrepot_sdc_filtre_final as
----------------
-- SYNTHÉTISÉ --
----------------
SELECT 
	...
	eidods.prop_culture_intermediaire as diversite_prop_culture_intermediaire,
    ...
    comm.codeinsee as domaine_position_code_insee,
	comm.commune as domaine_position_nom_commune,
	comm.departement as domaine_position_departement,
	comm.petiteregionagricolecode as domaine_position_petiteregionagricolecode,
	comm.codepostal as domaine_position_codepostal,
	comm.region as domaine_position_region,
	comm.ancienne_region as domaine_position_ancienne_region,
	interop.safran_cell_id as domaine_position_cellule_safran,
	interop.rmqs_site_id as domaine_position_rmqs_site_id,
	interop.bdgsf_smu as domaine_position_bdgsf_smu,
	interop.bdgsf_stu_id_1 as domaine_position_bdgsf_stu_id_1,
	interop.bdgsf_stu_pct_aire_1 as domaine_position_bdgsf_stu_pct_aire_1,
	interop.bdgsf_stu_id_2 as domaine_position_bdgsf_stu_id_2,
	interop.bdgsf_stu_pct_aire_2 as domaine_position_bdgsf_stu_pct_aire_2,
	...
	ssp.qsa_cuivre_metal_tot_hts as sdc_qsa_cuivre_tot_hts,
	ssp.qsa_cuivre_metal_tot as sdc_qsa_cuivre_tot,
	ssp.qsa_cuivre_metal_phyto_hts as sdc_qsa_cuivre_phyto_hts,
	ssp.qsa_cuivre_metal_ferti as sdc_qsa_cuivre_ferti,
	...
	ssp.ges_totaux_directes_ges_total + ges_totaux_indirectes_ges_total as sdc_ges_total_co2eq,
	ssp.ges_totaux_directes_ges_total as sdc_ges_directs_co2eq,
	ssp.ges_totaux_indirectes_ges_total as sdc_ges_indirects_co2eq,
...
SELECT 
	...
	eidodr.prop_culture_intermediaire as diversite_prop_culture_intermediaire,
	...
	srp.qsa_cuivre_metal_tot_hts as sdc_qsa_cuivre_tot_hts,
	srp.qsa_cuivre_metal_tot as sdc_qsa_cuivre_tot,
	srp.qsa_cuivre_metal_phyto_hts as sdc_qsa_cuivre_phyto_hts,
	srp.qsa_cuivre_metal_ferti as sdc_qsa_cuivre_ferti,
	...
	srp.ges_totaux_directes_ges_total + ges_totaux_indirectes_ges_total as sdc_ges_total_co2eq,
	srp.ges_totaux_directes_ges_total as sdc_ges_directs_co2eq,
	srp.ges_totaux_indirectes_ges_total as sdc_ges_indirects_co2eq,
