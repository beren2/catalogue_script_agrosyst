...
SELECT
    ...
    null as Rdt_Circuit_Court,-- idem ?
    null as Rendement_total,-- idem ?
    eirp.ift_histo_chimique_tot        AS ift_histo_chimique_tot_CP,
    eirp.ift_histo_chim_tot_hts        AS ift_histo_chim_tot_hts_CP,
    eirp.ift_histo_biocontrole         AS ift_histo_biocontrole_CP,
    eirp.ift_histo_hh                  AS ift_histo_hh_CP,
    eirp.ift_histo_f                   AS ift_histo_f_CP,
    eirp.ift_histo_i                   AS ift_histo_i_CP,
    eirp.ift_histo_a                   AS ift_histo_a_CP,
    eirp.ift_histo_ts                  AS ift_histo_ts_CP,
    ...
    eirp.ift_cible_mil_hh                AS ift_cible_mil_hh_CP,
    eirp.ift_cible_mil_f                 AS ift_cible_mil_f_CP,
    ...
    eirp.ift_cible_non_mil_chimique_tot  AS ift_cible_non_mil_chimiq_tot_CP,
    eirp.ift_cible_non_mil_biocontrole   AS ift_cible_non_mil_biocontrole_CP,
    eirp.ift_cible_non_mil_h              AS ift_cible_non_mil_h_CP,
    eirp.ift_cible_non_mil_hh             AS ift_cible_non_mil_hh_CP,
    eirp.ift_cible_non_mil_f              AS ift_cible_non_mil_f_CP,
    ...
    eirp.ift_culture_mil_chim_tot_hts     AS ift_culture_mil_chim_tot_hts_CP,
    eirp.ift_culture_mil_biocontrole      AS ift_culture_mil_biocontrole_CP,
    eirp.ift_culture_mil_h                 AS ift_culture_mil_h_CP,
    eirp.ift_culture_mil_hh                AS ift_culture_mil_hh_CP,
    eirp.ift_culture_mil_f                 AS ift_culture_mil_f_CP,
    eirp.ift_culture_mil_i                 AS ift_culture_mil_i_CP,
    eirp.ift_culture_mil_ts                AS ift_culture_mil_ts_CP,
    eirp.ift_culture_non_mil_chim_tot_hts  AS ift_culture_non_mil_chim_tot_hts_CP,
    eirp.ift_culture_non_mil_biocontrole   AS ift_culture_non_mil_biocontrole_CP,
    eirp.ift_culture_non_mil_h              AS ift_culture_non_mil_h_CP,
    eirp.ift_culture_non_mil_hh             AS ift_culture_non_mil_hh_CP,
    eirp.ift_culture_non_mil_f              AS ift_culture_non_mil_f_CP,
    eirp.ift_culture_non_mil_i              AS ift_culture_non_mil_i_CP,
    eirp.ift_culture_non_mil_ts             AS ift_culture_non_mil_ts_CP,
    eirp.qsa_tot                            AS quantite_mat_active_CP,
    eirp.qsa_danger_environnement          AS quantite_mat_active_danger_CP,
    eirp.qsa_danger_environnement_hts      AS qte_mat_active_danger_env_CP,
    eirp.qsa_cmr                            AS quantite_mat_active_CMR_CP,
    eirp.qsa_cmr_hts                        AS quantite_mat_active_glypho_CP,
    eirp.qsa_cuivre_phyto_hts               AS quantite_mat_active_neonic_CP,
    eirp.qsa_cuivre_metal_tot                 AS quantite_cuivre_CP,
    eirp.qsa_cuivre_metal_ferti               AS qte_cuivre_engrais_CP,
    eirp.qsa_cuivre_metal_phyto               AS qte_cuivre_phyto_CP,
    eirp.qsa_soufre_tot                      AS quantite_soufre_CP,
    eirp.qsa_soufre_ferti                     AS qte_soufre_engrais_CP,
    eirp.qsa_soufre_phyto_hts                 AS qte_soufre_phyto_CP,
    null AS nb_intrants_verif_biocontrole, -- à venir sur Agrosyst
    ...
    eirp.c_main_oeuvre_manuelle_reelle      AS c_main_oeuvre_manuelle_reelle_CP,
    eirp.c_main_oeuvre_manuelle_reelle_tx_comp  AS c_main_oeuvre_manuelle_reelle_tx_comp_CP,
    eirp.c_main_oeuvre_tractoriste_reelle  AS c_main_oeuvre_tractoriste_reelle_CP,
    ...
    eirp.tps_utilisation_materiel_fevrier    AS tps_util_materiel_fevrier_CP,
    eirp.tps_utilisation_materiel_mars       AS tps_util_materiel_mars_CP,
    eirp.tps_utilisation_materiel_avril      AS tps_util_materiel_avril_CP,
    eirp.tps_utilisation_materiel_mai        AS tps_util_materiel_mai_CP,
    eirp.tps_utilisation_materiel_juin       AS tps_util_materiel_juin_CP,
    eirp.tps_utilisation_materiel_juillet     AS tps_util_materiel_juillet_CP,
    eirp.tps_utilisation_materiel_aout      AS tps_util_materiel_aout_CP,
    eirp.tps_utilisation_materiel_sept       AS tps_util_materiel_sept_CP,
    eirp.tps_utilisation_materiel_oct         AS tps_util_materiel_oct_CP,
    eirp.tps_utilisation_materiel_nov         AS tps_util_materiel_nov_CP,
    eirp.tps_utilisation_materiel_dec         AS tps_util_materiel_dec_CP,
    eirp.tps_travail_manuel                  AS tps_travail_manuel_CP,
    eirp.tps_travail_manuel_tx_comp          AS tps_travail_manuel_tx_comp_CP,
    eirp.tps_travail_manuel_janvier          AS tps_travail_manuel_janvier_CP,
    eirp.tps_travail_manuel_fevrier          AS tps_travail_manuel_fevrier_CP,
    eirp.tps_travail_manuel_mars             AS tps_travail_manuel_mars_CP,
    eirp.tps_travail_manuel_avril            AS tps_travail_manuel_avril_CP,
    eirp.tps_travail_manuel_mai              AS tps_travail_manuel_mai_CP,
    eirp.tps_travail_manuel_juin             AS tps_travail_manuel_juin_CP,
    eirp.tps_travail_manuel_juillet           AS tps_travail_manuel_juillet_CP,
    eirp.tps_travail_manuel_aout            AS tps_travail_manuel_aout_CP,
    eirp.tps_travail_manuel_septembre        AS tps_travail_manuel_septembre_CP,
    eirp.tps_travail_manuel_octobre          AS tps_travail_manuel_octobre_CP,
    eirp.tps_travail_manuel_novembre         AS tps_travail_manuel_novembre_CP,
    eirp.tps_travail_manuel_decembre        AS tps_travail_manuel_decembre_CP,
    eirp.qsa_tot                   AS quantite_mat_active_CP,
    eirp.ferti_n_tot                        AS N_CP,
    eirp.ferti_n_mineral                    AS N_Mineral_CP,
    eirp.ferti_n_organique                  AS N_Orga_CP,
    eirp.ferti_p2o5_tot                     AS P_CP,
    eirp.ferti_p2o5_mineral                 AS P_Mineral_CP,
    eirp.ferti_p2o5_organique               AS P_Orga_CP,
    ...
    eirp.alerte_msn_std_mil_avec_autoconso AS Alerte_recolte_cult_princi,
    null AS Alerte_travail_sol, -- à venir sur Agrosyst
    eirp.c_main_oeuvre_manuelle_reelle    AS cout_mo_manuelle_CP,
    eirp.c_main_oeuvre_manuelle_reelle_tx_comp  AS cout_mo_manuelle_cp_tx_comp,
    eirp.c_main_oeuvre_tractoriste_reelle    AS cout_mo_tractoriste_CP,
    eirp.c_main_oeuvre_tractoriste_reelle_tx_comp  AS cout_mo_tractoriste_cp_tx_comp,
    eirp.alerte_nombre_interventions_phyto  AS rec_moyens_biologiques_CP,
    eirp.recours_macroorganismes          AS recours_macroorganismes_CP,
    eirp.recours_produits_biotiques_sansamm  AS rec_pdts_biot_sansamm_CP,
    eirp.recours_produits_abiotiques_sansamm AS rec_pdts_abiot_sansamm_CP,
    eirp.ift_cible_non_mil_chimique_tot     AS ift_cible_non_mil_chimiq_tot_CP,
    eirp.ift_cible_non_mil_biocontrole     AS ift_cible_non_mil_biocontrole_CP,
    eirp.ift_cible_non_mil_h                AS ift_cible_non_mil_h_CP,
    eirp.ift_cible_non_mil_hh               AS ift_cible_non_mil_hh_CP,
